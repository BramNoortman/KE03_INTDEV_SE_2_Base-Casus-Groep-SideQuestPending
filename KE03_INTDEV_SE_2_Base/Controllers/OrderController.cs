...
namespace KE03_INTDEV_SE_2_Base.Controllers
{
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> Index(string search)
        {
            ...
            {
                query = query.Where(o => o.Name.Contains(search) || o.Address.Contains(search) || o.Active.ToString().Contains(search));
            }

            ViewBag.Search = search;
            var customers = await query.OrderBy(c => o.Id).ToListAsync();
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var customer = await _context.Order
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var customer = await _context.Order.FindAsync(id);
            if (customer == null)
            {
                return NotFound();
            }
